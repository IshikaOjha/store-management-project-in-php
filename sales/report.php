...
if(isset($_GET['submit'])){
  ...
  $sql="SELECT * from bill where bill_date='$date'";
...
<li class="active"> <a href="report.php"><b>Report</b></a></li>
...
<div class="panel panel-heading" align="center" style="background-color:#d5dae2; font-size:20px; color:red;"><b> Report Details</b></div>
<div style="margin:5%">

<form method="GET">
<div class="row-sm-1" align="left">
<label>Date:</label> 
...
<?php
if($bill_result){
 while($item=mysqli_fetch_assoc($bill_result)){?>

<tr>
<td> <?php echo$item['bill_id'];?></td>
<td> <?php echo$item['bill_date'];?></td>
<?php
  $customer_id=$item['c_id'];
