...
<li class="active"> <a href="delete.php"> <b>Delete</b> </a> </li>
...
<td><a href="delete_customer.php?id=<?php echo $item ['id'];?>"><input type="button"  class="btn btn-danger" onclick="return deletedata();" value="Delete"></a></td>
</tr>
<?php } mysqli_close($db);?>
</table>
</div>
